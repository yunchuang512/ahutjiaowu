...
public class BaseDialogInfo extends Dialog implements
	...
	private static BaseDialogInfo mBaseDialog;// 当前的对话框
	...
	public BaseDialogInfo(Context context) {
	...
	public static BaseDialogInfo getDialog(Context context, CharSequence title,
	...
	public static BaseDialogInfo getDialog(Context context, CharSequence title,
		...
		mBaseDialog = new BaseDialogInfo(context);
